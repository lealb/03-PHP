...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            <div id="chart9" style="width: 1300px;height: 500px"></div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div id="chart20" style="width: 1366px;height: 600px"></div>
        </div>
        <div class="col-md-6">
            <div id="chart21" style="width: 550px;height: 200px"></div>
        </div>
        <div class="col-md-6">
            <div id="chart22" style="width: 700px;height: 400px"></div>
        </div>
        <div class="col-md-6">
        ...
        series: [
            {
                ...
                data:[
                    {value:5169, name:'微信上报',selected:true},
                    {value:2698, name:'电话举报'}
                ]
            },
            {
                name:'访问来源',
                ...
                radius: ['40%', '55%'],
                data:[
                    {value:1959, name:'宣传广告'},
                    {value:1651, name:'无照游商'},
                    {value:1569, name:'暴露垃圾'},
                    {value:556, name:'噪音类'},
                    {value:403, name:'施工扰民'},
                    {value:264, name:'违法建筑'},
                    {value:218, name:'下水道堵塞'},
                    {value:142, name:'大气污染'}
        ...
        series: [
            {
                ...
                data: [
                    {
                        value: [4058, 93.57, 18.07, 74.77, 7.37],
                        name: '南明区',
                        opacity: 0.9
                    },
                    {
                        value: [7867, 98.65, 36.93, 90.95, 4.28],
                        name: '云岩区',
                        label: {
                            normal: {
                                show: true,
        ...
        polar : [
            {
                ...
                show: true,
                indicator : [
                    {text : '宣传广告', max  : 2000},//285
                    {text : '无照游商', max  : 2000},//801
                    {text : '暴露垃圾', max  : 2000},//184
