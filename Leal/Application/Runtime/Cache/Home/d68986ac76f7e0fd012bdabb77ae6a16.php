...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/map/guiyang.js"></script>
    <script type="text/javascript" src="/Public/Home/js/map/nanmingqu.js"></script>
    <style>
        #chart{
           margin-top: 145px;
           margin-left: 450px;
...
<div id="chart" style="width: 1050px;height: 825px"></div>
</body>
<script>
